...
Originally intended for large scale genome wide 
association studies (GWAS). This is to investigate whether we have associations
that are stronger than what one would expect by pure randomness.
